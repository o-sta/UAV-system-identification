...
% ● 目標値制限設定
%--------------------------------------------------------------------------
target_angular_limit = 10*pi/180; %目標姿勢 phi theta の上限
target_velocity_limit = 1;
input_thrust_limit = 30;
input_torque_x_limit = 0.5;
input_torque_y_limit = 0.5;
input_torque_z_limit = 0.5;
target_velocity_z_limit = 3;

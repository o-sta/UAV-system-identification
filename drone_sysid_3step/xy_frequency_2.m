...
io(1)=linio('xy_frequency/target_x',1,'openinput');
io(2)=linio('xy_frequency/est_out_x',1,'output');

yio(1)=linio('xy_frequency/target_yy',1,'openinput');
yio(2)=linio('xy_frequency/est_out_y',1,'output');

linsys = linearize(sys,io);
pole(linsys)

ylinsys = linearize(sys,yio);
pole(ylinsys)
